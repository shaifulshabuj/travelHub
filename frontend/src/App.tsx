...
const Bookings = () => (
  <div style={{ padding: '2rem' }}>
    ...
    <a href="/" style={{ color: '#1e40af' }}>← Back to Home</a>
    <br />
    <a href="/broken-link" style={{ color: '#dc2626' }}>This is a broken link</a>
  </div>
);
...
const About = () => (
  <div style={{ padding: '2rem' }}>
    ...
    <a href="/" style={{ color: '#1e40af' }}>← Back to Home</a>
    <br />
    <a href="https://nonexistent-domain-123456.com" style={{ color: '#dc2626' }}>External broken link</a>
  </div>
);
...
const Contact = () => (
  <div style={{ padding: '2rem' }}>
    ...
    <a href="/" style={{ color: '#1e40af' }}>← Back to Home</a>
    <br />
    <a href="#footer" style={{ color: '#1e40af' }}>Jump to footer (missing footer)</a>
  </div>
);
