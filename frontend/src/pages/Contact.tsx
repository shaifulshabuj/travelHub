            ...
            <div className="mt-8 pt-8 border-t border-gray-200">
              ...
              <div className="flex space-x-4">
                ...
                <a href="#" className="w-10 h-10 bg-pink-600 rounded-full flex items-center justify-center text-white hover:bg-pink-700 transition-colors">
                  ...
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 0C4.477 0 0 4.477 0 10s4.477 10 10 10 10-4.477 10-10S15.523 0 10 0zm4.125 5.688a1.25 1.25 0 00-1.25-1.25H7.125a1.25 1.25 0 00-1.25 1.25v8.624a1.25 1.25 0 001.25 1.25h5.75a1.25 1.25 0 001.25-1.25V5.688zM10 13.125A3.125 3.125 0 1110 6.875a3.125 3.125 0 010 6.25zm3.125-7.5a.625.625 0 11-1.25 0 .625.625 0 011.25 0z" clipRule="evenodd" />
                  </svg>
                </a>
              </div>
            </div>
